export const authConfig = {
  ...
  callbacks: {
      async authorized({ auth, request }) {
          ...
          const isOnProtectedPage = request.nextUrl.pathname.startsWith("/Blogger") || request.nextUrl.pathname.startsWith("/Projects");

          // إذا كان المستخدم غير مسجل الدخول ويحاول الوصول إلى صفحة محمية، أعد توجيهه إلى صفحة تسجيل الدخول
